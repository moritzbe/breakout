...
position0 = team3.positions.create(latitude: 48.150473, longitude: 11.581189, text: "Doa bin I dahoam")
...
position0 = team4.positions.create(latitude: 48.150473, longitude: 11.581189, text: "Hier sin mia dahoam")
position1 = team4.positions.create(latitude: 49.989334, longitude: 14.782983, text: "Prahahahaha")
position2 = team4.positions.create(latitude: 52.196791, longitude: 21.242943, text: "Poland here we come")
position4 = team4.positions.create(latitude: 54.784177, longitude: 23.879663, text: "Hola Vilnius!")
position5 = team4.positions.create(latitude: 56.953325, longitude: 24.407007, text: "Riga and the sea")
